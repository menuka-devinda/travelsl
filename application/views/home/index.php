	...
	<main class="main" role="main">
		...
		<div class="hero">
			<article>
				<h1 class="wow fadeInDown">For an unforgettable sailing experience...</h1>
				<a href="#lightSliderDeals" title="Begin your sailing adventure" class="anchor button white medium wow fadeInUp">Begin your sailing adventure</a>
			</article>
		</div>
		<!-- //Hero -->
			...
			<nav class="tabs four" role="navigation">
				<ul class="wrap">
					...
					<li><a href="charters.html" title="Check our Early Season Mediterranean Deals.">
						<img src="images/ico2.png" alt="" /> Check our Early Season Mediterranean Deals.
					</a></li>
					<li><a href="services.html" title="New to Sailing? We‘ve got you covered.">
						<img src="images/ico3.png" alt="" /> New to Sailing?<br />We‘ve got you covered.
					</a></li>
