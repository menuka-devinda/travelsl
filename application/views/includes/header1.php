...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo  "Oldtimerslost.com - Let's find them, it's about time"; ?></title>
               ...
               <tr>
                 ...
                 <td> 
                    <a style="color:red;" href="<?php echo base_url()?><?php $this->lang->lang() ?>user/changeDetails">
                       Settings  <!-- <img border="0" src="<?php //base_url(); ?>/images/user_gray.png" /> -->
                     </a>  
                 ...
                 <td> <?php  $is_logged_in = $this->session->userdata('is_logged_in');
                             $user_level = $this->session->userdata('user_level');
                               ...
                               {
                                   ?>
                                    <a style="color:red;" href="<?php echo base_url()?><?php $this->lang->lang() ?>admin/viewAllAdds">
                      Control panel  
                     </a>
                             <?php  }  ?>  </td>
               </tr>
               ...
               <tr><td>
                 ...
                 <?php } ?>
				  <div id="social_media" style="background-color:transparent; width:390px;">
                       ...
                       <div id="tweeter" style="border-radius: 5px;float: left;  height: 15px; width: 75px; padding: 5px; padding-top: 5px; background-color:transparent;border-radius:5px;">

                            <div style="float:right;height: 5px;">  <a href="http://twitter.com/oldtimerslost" target="_blank" ><img border="0" style="height:25px;width:75px; " src="<?php echo base_url(); ?>images/twitterLogo2.jpg" /></img> </a>
                             </div>
                           
                        </div>      
                        <div style="border-radius: 5px; border-spacing: 5px;  float: left; height: 15px; width: 40px; padding: 5px;padding-bottom: 10px;">
                            <div style="float:right;height: 5px;">  <a href="http://www.facebook.com/pages/Oldtimerslostcom/194929117258377" target="_blank" ><img border="0" style="height:25px;width:24px; " src="<?php echo base_url(); ?>images/fblogo1.jpg" /></img> </a>
