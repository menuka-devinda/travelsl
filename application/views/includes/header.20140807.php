...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="keywords" content="oldtimers,stolencars,netherland stolen cars, oldtimerslost, lost cars. stolen cars, netherland oldtimers, lost oldtimers,Security vintage, vintage car, vintage cars, security, immobilizer, immobilizer, immobilizer, alarm, alarm, alarms, track and trace, level transmitter, level transmitters,
              tracking, tracking, vehicle tracking, vehicle tracking, pac,Oldtimer Nederland, Uw oldtimer site | klassieker, klassiekers, classics, classic car, oldtimers, oldtimer, classic, oldtimerverzekering, klassiekerverzekering, verzekering, vraag, aanbod, tweedehands, adverteren, advertentie, oud, oude,
		 ...
		 <td>
			  ...
			  <?php echo form_open(base_url() . $this->lang->lang() . '/user/login');?>
               ...
               <tr><td>
                 ...
                 <?php } ?>
				  <div id="social_media" style="background-color:transparent; width:390px;">
				  
                       <div id="tweeter" style="border-radius: 5px;float: left;  height: 15px; width: 30px; padding-top: 5px; background-color:transparent;border-radius:5px;">

                            <div style="float:right;height: 5px;">  <a href="http://twitter.com/oldtimerslost" target="_blank" ><img border="0" style="height:25px;width:24px;" src="<?php echo base_url(); ?>images/twitter.jpg" /></img> </a>
                             </div>
                           
                        </div>      
                        <div style="border-radius: 5px; border-spacing: 5px;  float: left; height: 15px; width: 30px; ">
                            <div style="float:right;height: 5px;">  <a href="http://www.facebook.com/pages/Oldtimerslostcom/194929117258377" target="_blank" ><img border="0" style="height:25px;width:24px;padding-top: 5px; " src="<?php echo base_url(); ?>images/fb.jpg" /></img> </a>
